          ...
          <div className="header__container">
            <nav className="header__nav">
              <Link className="header__title-link" href="/">
               <h1 className="header__title h2">Inertia/React/Laravel CRUD app</h1>
              </Link>
